...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($action === 'delete_question') {
        ...
        $conn->query("INSERT INTO questions (question, option_a, option_b, option_c, option_d, correct_answer) VALUES ('$q', '$opt_a', '$opt_b', '$opt_c', '$opt_d', '$ans')");
        ...
        $opt_d = $conn->real_escape_string($_POST['option_d']);
        $ans = $conn->real_escape_string($_POST['correct_answer']);
        $conn->query("UPDATE questions SET question='$q', option_a='$opt_a', option_b='$opt_b', option_c='$opt_c', option_d='$opt_d', correct_answer='$ans' WHERE id=$id");
...
<body>
    ...
    <main class="dashboard-container">
        ...
        <section class="card">
            <div class="card-header">
                <h2>MANAGE TRACK TELEMETRY (QUESTIONS)</h2>
            </div>
    ...
    <script>
        ...
        function openQuestionEdit(id, q, a, b, c, d, ans) {
